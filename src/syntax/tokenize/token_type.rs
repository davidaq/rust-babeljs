...

{
  ...
  def!(token OP_BIT_LEFT_ASSIGN := "<<="  <: OPERATOR | BEFORE_EXPR);
  def!(token OP_GT               = >      <: OPERATOR | BEFORE_EXPR);
  def!(token OP_EGT              = >=     <: OPERATOR | BEFORE_EXPR);
  def!(token OP_BIT_RIGHT_ASSIGN:= ">>="  <: OPERATOR | BEFORE_EXPR);
  def!(token OP_BIT_URIGHT_ASSIGN:= ">>>="<: OPERATOR | BEFORE_EXPR);
  ...
  def!(token OP_NOT_EQUAL_STRICT := "!==" <: OPERATOR | BEFORE_EXPR);
  ...
  def!(token OP_POW_ASSIGN      := "**="  <: OPERATOR | ASSIGN_OPERATOR | BEFORE_EXPR);
